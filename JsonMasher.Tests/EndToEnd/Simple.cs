    ...
    public class Simple
    {
        ...
        private static IEnumerable<TestItem> LetPrograms()
        {
            ...
            yield return new TestItem(
                ...
                "[[2, 1]]");
            yield return new TestItem(
                ". as {a: $a, c: $c} ?// [$b, $a] | [$a, $b, $c]",
                "[1, 2]",
                "[[2, 1, null]]");
            yield return new TestItem(
                ". as {a: $a, c: $c} ?// [$b, $a] ?// $a | [$a, $b, $c]",
                "10",
                "[[10, null, null]]");
        }
...
map(select(. < 2))",
        ...
        private static IEnumerable<TestItem> LabelBreak()
        {
            ...
            yield return new TestItem(
                "label $out | 1,2,3,(label $inner | def x: break $inner; x),4", "null", "[1,2,3,4]");
        }
        ...
        private static IEnumerable<TestItem> MathFunctions()
        {
            ...
            yield return new TestItem("nan | isnan", "2", "[true]");
            yield return new TestItem("infinite | isfinite", "2", "[false]");
